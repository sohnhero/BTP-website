    ...
    <footer ref={ref} className={`site-footer ${revealClass}`}>
      <div className="footer-card">
        ...
        <div className="footer-grid">
          {/* Left Reach Out & Newsletter Box */}
          <div className="footer-reach-col">
            <div className="footer-reach-group">
            ...
            <div className="footer-newsletter-box">
              <div className="newsletter-header">
                ...
                <h4 className="newsletter-title">L’actualité du BTP & Grands Projets</h4>
                <p className="newsletter-subtitle">
                  Recevez nos dernières réalisations, innovations techniques et opportunités en exclusivité.
                </p>
              </div>
              ...
              {isSubscribed ? (
                <div className="newsletter-success">
                  ...
                  <div>
                    ...
                    <p>Merci de votre confiance. Vous recevrez nos prochaines actualités.</p>
                  </div>
                </div>
              ) : (
                <form onSubmit={handleNewsletterSubmit} className="newsletter-form">
                  ...
                  <span className="newsletter-privacy">
