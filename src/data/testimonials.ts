...
export const testimonialsData: TestimonialItem[] = [
  ...
  },
  {
    ...
    quote: "Collaborer avec FIDELE SARL sur des ouvrages complexes est un vrai plaisir d'ingénieur. Rigueur technique exemplaire, conformité Eurocodes et présence réactive sur le terrain.",
    rating: 5,
